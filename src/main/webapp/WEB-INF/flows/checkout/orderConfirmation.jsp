					...
					<div class="row">
						<div class="col-xs-6 col-sm-6 col-md-6">
							<address>
								...
								${order.reader.name}<br>
								${order.reader.billingAddress.doorNo},${order.reader.billingAddress.streetName}
								<br>
								${order.reader.billingAddress.areaName},${order.reader.billingAddress.state}
								<br>
								${order.reader.billingAddress.country},${order.reader.billingAddress.zipCode}
								<br> <abbr title="Phone">P:</abbr>
								${order.reader.phoneNumber}
							</address>
						</div>
						...
						<table class="table table-hover">
							...
							<tbody>
								<c:forEach var="cartItem" items="${order.cart.cartItems}">
									<tr>
										<td class="col-md-9"><em>${cartItem.value.book.bookTitle}</em></td>
										<td class="col-md-1" style="text-align: center">
											${cartItem.value.quantity}</td>
										<td class="col-md-1 text-center">$${cartItem.value.book.pricePerUnit}</td>

...
<body>
	...
	<section class="container">
		<form:form modelAttribute="order.reader" class="form-horizontal">
			<fieldset>
				<legend>Customer Details</legend>

				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2" for="readerId" />Reader Id</label>
					<div class="col-lg-10">
						<form:input id="readerId" path="readerId" type="text" class="form:input-large" />
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-lg-offset-2 col-lg-10">
						<input type="submit" id="btnAdd" class="btn btn-primary"
							value="Add" name="_eventId_readerInfoCollected" />
